...
class PoseEstimator:
    ...
    def ret(self):
        return self.dist_coeefs,self.camera_matrix,self.model_points
    ...
    def cal_eye_index(self,marks):
        # print(marks[30,)
        # a= self.get_pose_mark(self,marks)
        # print(a)
        x1=marks[36][0]
        y1=marks[36][1]
        x2=marks[45][0]
        ...
        x4 = x3 - k * (y2-y1)
        y4 = y3 + k * (x2-x1)
        dst = distance.euclidean((x1,y1), (x4,y4))
        dst2 = distance.euclidean((x1,y1), (x2,y2))
        index=dst/dst2
